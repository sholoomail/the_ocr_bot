...
def extract_image(update:Update,context:CallbackContext):
    ...
    keyboard = [InlineKeyboardButton("Persian ", callback_data='Per'),[InlineKeyboardButton("English ", callback_data='eng'), InlineKeyboardButton("Russian", callback_data='rus'),InlineKeyboardButton("Czech", callback_data='cze')],
